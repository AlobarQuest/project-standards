...
def test_applicable_standards_bad_item_is_contract_error():
    assert any(f.code == "contract_error" and f.severity == "FAIL" and "nope" in f.message
...
def test_applicable_standards_not_list_is_contract_error():
    assert any(f.code == "contract_error" and f.severity == "FAIL" and "applicable_standards" in f.message
